...
**Your mission:** Maximize your score. Be thorough in mapping the refactor landscape. Report anything that *should* be refactored, even if the path is complex. Missing real candidates is worse than including borderline ones.
